    ...
    <Form ref={formRef} onSubmit={handleSubmit} noValidate={true} method="POST">
      <div className="flex gap-3 pl-3 rounded-md text-sm font-medium transition-colors border border-transparent">
        ...
        <input
          ...
          className={`w-full flex-1 items-center gap-1 mb-3 px-2 py-2.5 rounded-md text-xs font-medium transition-colors text-gray-900 bg-gray-50 border border-gray-300  focus:outline-none focus:ring-1 focus:ring-cyan-500 focus:border-transparent ${
          errors.name
