...
export async function action ({ request }: Route.ActionArgs) {
  ...
  // if folders exist, find the parent folder of "All Folders"
  if (folders) {
    allFoldersParent = folders.find(f => f.name === 'All Folders' && f.parentFolderId === null)
  }

  // get the id of the "All Folders" parent folder
  const allFoldersId = allFoldersParent ? allFoldersParent.id : null

  // create a new folder object with "All Folders" as the parent folder
  const folder = {
    id: uuid(),
