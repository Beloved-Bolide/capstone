        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="w-56 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div className="px-4 pt-4">
                    <button className="w-full flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 text-sm font-medium text-gray-700">
