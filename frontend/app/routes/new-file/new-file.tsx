...
const NewFile: React.FC = () => {
    ...
    // Check if amount field should be shown (only for Receipt or Invoice)
    const showAmountField = fileType === 'Receipt' || fileType === 'Invoice';
                ...
                <div className="bg-white rounded-lg shadow-xl">
                    ...
                    <div className="p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Expenses Section - Only shows for Receipt or Invoice */}
                            {showAmountField && (
                                <div>
                                    <h3 className="text-base font-medium text-gray-900 mb-4 pb-2 border-b border-gray-200">
                                        Financial Details
